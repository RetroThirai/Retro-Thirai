  ...
  posterData.forEach((poster, index) => {
    ...
    item.innerHTML = `
      <div class="gallery-image-wrapper">
        ...
        <img src="${poster.image}" alt="${poster.title}" class="gallery-image loading" loading="lazy" />
      </div>
    ...
    img.addEventListener('error', () => placeholder.remove());
...
function openLightbox(index) {
  ...
  document.getElementById('lightbox-image').src = poster.image;
  document.getElementById('lightbox-title').textContent = poster.title;
  document.getElementById('lightbox-category').textContent = poster.category;
...
function navigateLightbox(direction) {
  currentPosterIndex = (currentPosterIndex + direction + posterData.length) % posterData.length;
